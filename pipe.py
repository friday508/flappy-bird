...
class Pipe:
    def __init__(self,scale_factor,move_speed):
        self.img_up=pg.transform.scale_by(pg.image.load(resource_path("Images/pipeup.png")).convert_alpha(),scale_factor)
        self.img_down=pg.transform.scale_by(pg.image.load(resource_path("Images/pipedown.png")).convert_alpha(),scale_factor)
