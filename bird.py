...
class Bird(pg.sprite.Sprite):
    def __init__(self,scale_factor):
        ...
        self.img_list=[pg.transform.scale_by(pg.image.load(resource_path("Images/birdup.png")).convert_alpha(),scale_factor),
                       pg.transform.scale_by(pg.image.load(resource_path("Images/birddown.png")).convert_alpha(),scale_factor)]
        self.image_index=0
